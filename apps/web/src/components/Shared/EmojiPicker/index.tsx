  ...
  return (
    <Tooltip content="Emoji" placement="top" withDelay>
      <div className="relative" ref={listRef}>
        ...
        {showEmojiPicker ? (
          <div className="absolute z-[5] mt-1 w-[300px] rounded-xl border border-gray-200 bg-white shadow-xs focus:outline-hidden dark:border-gray-800 dark:bg-gray-900">
