...
export type AccountFragment = { __typename: 'Account', owner: any, address: any, score: number, createdAt: any, isAdmin: boolean, rules: { __typename: 'AccountFollowRules', anyOf: Array<(
      { __typename: 'AccountFollowRule' }
...
export type FeedFragment = { __typename: 'Feed', address: any, rules: { __typename: 'FeedRules', required: Array<(
      { __typename: 'FeedRule' }
      & FeedRuleFragment
    )> } };

export type FeedRuleFragment = { __typename: 'FeedRule', address: any, id: any, config: Array<
    | { __typename: 'AddressKeyValue' }
    | { __typename: 'ArrayKeyValue' }
    | { __typename: 'BigDecimalKeyValue' }
...
export type GroupFragment = { __typename: 'Group', address: any, owner: any, membershipApprovalEnabled: boolean, timestamp: any, feed?: (
    { __typename: 'Feed' }
    & FeedFragment
  ) | null, rules: { __typename: 'GroupRules', anyOf: Array<(
      { __typename: 'GroupRule' }
      & GroupRuleFragment
    )>, required: Array<(
      { __typename: 'GroupRule' }
...
export type GroupMemberFragment = { __typename: 'GroupMember', account: (
    { __typename: 'Account' }
    & AccountFragment
  ) };
...
export type AccountActionExecutedNotificationFragment = { __typename: 'AccountActionExecutedNotification', id: any, actions: Array<
    | { __typename: 'TippingAccountActionExecuted', executedAt: any, executedBy: (
        { __typename: 'Account' }
        & AccountFragment
      ), tipAmount:
        | (
    ...
    | { __typename: 'UnknownAccountActionExecuted', executedAt: any, executedBy: (
        { __typename: 'Account' }
        & AccountFragment
      ) }
  > };
...
export type CommentNotificationFragment = { __typename: 'CommentNotification', id: any, comment: (
    { __typename: 'Post' }
    & ReferencedPostNotificationFragment
  ) };

export type FollowNotificationFragment = { __typename: 'FollowNotification', id: any, followers: Array<{ __typename: 'NotificationAccountFollow', followedAt: any, account: (
      { __typename: 'Account' }
      & AccountFragment
    ) }> };

export type GroupMembershipRequestApprovedNotificationFragment = { __typename: 'GroupMembershipRequestApprovedNotification', id: any, approvedAt: any, approvedBy: (
    { __typename: 'Account' }
    & AccountFragment
  ), group: (
    { __typename: 'Group' }
...
export type GroupMembershipRequestRejectedNotificationFragment = { __typename: 'GroupMembershipRequestRejectedNotification', id: any, rejectedAt: any, rejectedBy: (
    { __typename: 'Account' }
    & AccountFragment
  ), group: (
    { __typename: 'Group' }
...
export type PostActionExecutedNotificationFragment = { __typename: 'PostActionExecutedNotification', id: any, actions: Array<
    | { __typename: 'SimpleCollectPostActionExecuted', executedAt: any, executedBy: (
        { __typename: 'Account' }
        & AccountFragment
    ...
    | { __typename: 'TippingPostActionExecuted', executedAt: any, executedBy: (
        { __typename: 'Account' }
        & AccountFragment
      ), tipAmount:
        | (
    ...
    | { __typename: 'UnknownPostActionExecuted', executedAt: any, action: (
        { __typename: 'UnknownPostAction' }
...
export type ReactionNotificationFragment = { __typename: 'ReactionNotification', id: any, post: (
    ...
    & PostFragment
      ...
      { __typename: 'Account' }
      & AccountFragment
    ), reactions: Array<{ __typename: 'PostReaction', reactedAt: any, reaction: PostReactionType }> }> };

export type ReferencedPostNotificationFragment = (
  { __typename: 'Post', commentOn?: (
    { __typename: 'Post' }
    & PostFragment
  ) | null, quoteOf?: (
    { __typename: 'Post' }
...
export type TokenDistributedNotificationFragment = { __typename: 'TokenDistributedNotification', id: any, actionDate: any, amount:
    | (
      { __typename: 'Erc20Amount' }
      & PayableAmount_Erc20Amount_Fragment
    )
...
export type LoggedInPostOperationsFragment = { __typename: 'LoggedInPostOperations', id: string, hasBookmarked: boolean, hasReacted: boolean, hasSimpleCollected: boolean, hasTipped: boolean, hasReported: boolean, isNotInterested: boolean, hasCommented: (
    { __typename: 'BooleanValue' }
...
export type PostFeedInfoFragment = { __typename: 'PostFeedInfo', address: any, group?: (
    { __typename: 'PostGroupInfo' }
...
export type PostOperationValidationFailedFragment = { __typename: 'PostOperationValidationFailed', unsatisfiedRules?: { __typename: 'PostUnsatisfiedRules', required: Array<{ __typename: 'PostUnsatisfiedRule', message: string }> } | null };
...
export type PostOperationValidationPassedFragment = { __typename: 'PostOperationValidationPassed', passed: any };
...
export type PostOperationValidationUnknownFragment = { __typename: 'PostOperationValidationUnknown', extraChecksRequired: Array<
    | (
      { __typename: 'FeedRule' }
      & PostOperationValidationRule_FeedRule_Fragment
    )
...
export type UnknownPostActionFragment = { __typename: 'UnknownPostAction', address: any, config: Array<{ __typename: 'RawKeyValue', data: any, key: any }> };
...
export type ConfigureAccountActionMutation = { __typename: 'Mutation', configureAccountAction:
...
export type UpdateFeedRulesMutation = { __typename: 'Mutation', updateFeedRules:
    | (
      { __typename: 'SelfFundedTransactionRequest' }
      & SelfFundedTransactionRequestFragment
    )
...
export type AddAdminsMutation = { __typename: 'Mutation', addAdmins:
    | (
      { __typename: 'SelfFundedTransactionRequest' }
      & SelfFundedTransactionRequestFragment
    )
...
export type ApproveGroupMembershipRequestsMutation = { __typename: 'Mutation', approveGroupMembershipRequests:
...
export type BanGroupAccountsMutation = { __typename: 'Mutation', banGroupAccounts:
...
export type RejectGroupMembershipRequestsMutation = { __typename: 'Mutation', rejectGroupMembershipRequests:
...
export type RemoveAdminsMutation = { __typename: 'Mutation', removeAdmins:
    | (
      { __typename: 'SelfFundedTransactionRequest' }
      & SelfFundedTransactionRequestFragment
    )
...
export type MeQuery = { __typename: 'Query', me: { __typename: 'MeResult', isSignless: boolean, loggedInAs:
      | { __typename: 'AccountManaged', account: (
          { __typename: 'Account' }
          & AccountFragment
        ) }
...
export type NotificationIndicatorQuery = { __typename: 'Query', notifications: { __typename: 'PaginatedNotificationResult', items: Array<
      | { __typename: 'AccountActionExecutedNotification', actions: Array<
          | { __typename: 'TippingAccountActionExecuted', executedAt: any }
          | { __typename: 'UnknownAccountActionExecuted', executedAt: any }
        > }
      | { __typename: 'CommentNotification', comment: { __typename: 'Post', timestamp: any } }
      | { __typename: 'FollowNotification', followers: Array<{ __typename: 'NotificationAccountFollow', followedAt: any }> }
      | { __typename: 'GroupMembershipRequestApprovedNotification', approvedAt: any }
      | { __typename: 'GroupMembershipRequestRejectedNotification', rejectedAt: any }
      | { __typename: 'MentionNotification', post: { __typename: 'Post', timestamp: any } }
      | { __typename: 'PostActionExecutedNotification', actions: Array<
          | { __typename: 'SimpleCollectPostActionExecuted', executedAt: any }
          | { __typename: 'TippingPostActionExecuted', executedAt: any }
          | { __typename: 'UnknownPostActionExecuted', executedAt: any }
        > }
      | { __typename: 'QuoteNotification', quote: { __typename: 'Post', timestamp: any } }
      | { __typename: 'ReactionNotification', reactions: Array<{ __typename: 'NotificationAccountPostReaction', reactions: Array<{ __typename: 'PostReaction', reactedAt: any }> }> }
      | { __typename: 'RepostNotification', reposts: Array<{ __typename: 'NotificationAccountRepost', repostedAt: any }> }
...
export type TopAccountsQuery = { __typename: 'Query', posts: { __typename: 'PaginatedAnyPostsResult', items: Array<
      | { __typename: 'Post', author: (
          { __typename: 'Account' }
          & AccountFragment
        ) }
      | { __typename: 'Repost' }
...
export type AdminsForQuery = { __typename: 'Query', adminsFor: { __typename: 'PaginatedAdminsResult', items: Array<{ __typename: 'Admin', account: (
        { __typename: 'Account' }
        & AccountFragment
      ) }>, pageInfo: (
      { __typename: 'PaginatedResultInfo' }
...
export type FullGroupQuery = { __typename: 'Query', group?: (
    { __typename: 'Group' }
    & GroupFragment
...
export type GroupBannedAccountsQuery = { __typename: 'Query', groupBannedAccounts: { __typename: 'PaginatedGroupBannedAccountsResult', items: Array<{ __typename: 'GroupBannedAccount', account: (
        { __typename: 'Account' }
        & AccountFragment
...
export type GroupMembershipRequestsQuery = { __typename: 'Query', groupMembershipRequests: { __typename: 'PaginatedGroupMembershipRequestsResult', items: Array<{ __typename: 'GroupMembershipRequest', requestedAt: any, account: (
        { __typename: 'Account' }
        & AccountFragment
      ) }>, pageInfo: (
      { __typename: 'PaginatedResultInfo' }
...
export const PaginatedResultInfoFragmentDoc = gql`
  ...
  next
    ...
    `;
export const GroupMetadataFragmentDoc = gql`
  ...
  coverPicture
    ...
    `;
export const PostGroupInfoFragmentDoc = gql`
...
export const PostFeedInfoFragmentDoc = gql`
...
export const AnyKeyValueFragmentDoc = gql`
  ...
  ... on StringKeyValue {
    ...
    `;
export const AccountFollowRuleFragmentDoc = gql`
...
export const LoggedInAccountOperationsFragmentDoc = gql`
...
export const VideoMetadataFragmentDoc = gql`
...
${MediaVideoFragmentDoc}
${AnyMediaFragmentDoc}`;
export const ArticleMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const AudioMetadataFragmentDoc = gql`
...
${AnyMediaFragmentDoc}
${MediaImageFragmentDoc}`;
export const LinkMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const LivestreamMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const MintMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const TextOnlyMetadataFragmentDoc = gql`
  ...
  attributes {
    ...
    ${MetadataAttributeFragmentDoc}`;
export const CheckingInMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const SpaceMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const StoryMetadataFragmentDoc = gql`
  ...
  attributes {
    ...
    ${MetadataAttributeFragmentDoc}`;
export const ThreeDMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const EmbedMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const TransactionMetadataFragmentDoc = gql`
  ...
  attachments {
    ...
    ${MetadataAttributeFragmentDoc}
${AnyMediaFragmentDoc}`;
export const EventMetadataFragmentDoc = gql`
...
export const PostStatsFragmentDoc = gql`
  ...
  tips
    ...
    `;
export const BooleanValueFragmentDoc = gql`
    fragment BooleanValue on BooleanValue {
  onChain
  optimistic
}
    `;
export const PostOperationValidationFailedFragmentDoc = gql`
  ...
  unsatisfiedRules {
    ...
    `;
export const PostOperationValidationPassedFragmentDoc = gql`
    fragment PostOperationValidationPassed on PostOperationValidationPassed {
  passed
}
    `;
export const PostRuleFragmentDoc = gql`
    fragment PostRule on PostRule {
  address
}
    `;
export const FeedRuleFragmentDoc = gql`
  ...
  id
    ...
    `;
export const PostOperationValidationRuleFragmentDoc = gql`
  ...
  ...FeedRule
    ...
    ${PostRuleFragmentDoc}
${FeedRuleFragmentDoc}`;
export const PostOperationValidationUnknownFragmentDoc = gql`
...
export const PostOperationValidationOutcomeFragmentDoc = gql`
...
export const LoggedInPostOperationsFragmentDoc = gql`
...
export const UnknownPostActionFragmentDoc = gql`
  ...
  config {
    ...
    `;
export const AccountMentionFragmentDoc = gql`
  ...
  replace {
    ...
    `;
export const GroupMentionFragmentDoc = gql`
  ...
  replace {
    ...
    `;
export const PostMentionFragmentDoc = gql`
...
export const ReferencedPostFragmentDoc = gql`
...
export const RepostFragmentDoc = gql`
...
export const ReferencedPostNotificationFragmentDoc = gql`
...
export const FeedFragmentDoc = gql`
  ...
  rules {
    ...
    ${FeedRuleFragmentDoc}`;
export const GroupRuleFragmentDoc = gql`
  ...
  config {
    ...
    ${AnyKeyValueFragmentDoc}`;
export const LoggedInGroupOperationsFragmentDoc = gql`
...
${GroupMetadataFragmentDoc}`;
export const GroupMembershipRequestApprovedNotificationFragmentDoc = gql`
  ...
  group {
    ...
    ${AccountFragmentDoc}
${GroupFragmentDoc}`;
export const GroupMembershipRequestRejectedNotificationFragmentDoc = gql`
...
export const ReactionNotificationFragmentDoc = gql`
  ...
  reactions {
    ...
    ${PostFragmentDoc}
${AccountFragmentDoc}`;
export const RepostNotificationFragmentDoc = gql`
  ...
  reposts {
    ...
    ${PostFragmentDoc}
${AccountFragmentDoc}`;
export const TokenDistributedNotificationFragmentDoc = gql`
  ...
  actionDate
    ...
    ${PayableAmountFragmentDoc}`;
export const AnyPostFragmentDoc = gql`
...
${UnknownPostActionFragmentDoc}`;
export const SelfFundedTransactionRequestFragmentDoc = gql`
  ...
  raw {
    ...
    `;
export const SponsoredTransactionRequestFragmentDoc = gql`
  ...
  raw {
    ...
    `;
export const TransactionWillFailFragmentDoc = gql`
    fragment TransactionWillFail on TransactionWillFail {
  reason
}
    `;
export const AddAccountManagerDocument = gql`
...
export const AssignUsernameToAccountDocument = gql`
...
export const ConfigureAccountActionDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useConfigureAccountActionMutation(baseOptions?: Apollo.MutationHookOptions<ConfigureAccountActionMutation, ConfigureAccountActionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ConfigureAccountActionMutation, ConfigureAccountActionMutationVariables>(ConfigureAccountActionDocument, options);
      }
export type ConfigureAccountActionMutationHookResult = ReturnType<typeof useConfigureAccountActionMutation>;
export const CreateAccountWithUsernameDocument = gql`
...
export const EnableSignlessDocument = gql`
...
export const ExecuteAccountActionDocument = gql`
...
export const HideManagedAccountDocument = gql`
...
export const RemoveAccountManagerDocument = gql`
...
export const RemoveSignlessDocument = gql`
...
export const ReportAccountDocument = gql`
...
export const SetAccountMetadataDocument = gql`
...
export const UnassignUsernameFromAccountDocument = gql`
...
export const UnhideManagedAccountDocument = gql`
...
export const UpdateAccountFollowRulesDocument = gql`
...
export const UnwrapTokensDocument = gql`
...
export const WrapTokensDocument = gql`
...
export const UpdateFeedRulesDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useUpdateFeedRulesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateFeedRulesMutation, UpdateFeedRulesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateFeedRulesMutation, UpdateFeedRulesMutationVariables>(UpdateFeedRulesDocument, options);
      }
export type UpdateFeedRulesMutationHookResult = ReturnType<typeof useUpdateFeedRulesMutation>;
export const AddAdminsDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useAddAdminsMutation(baseOptions?: Apollo.MutationHookOptions<AddAdminsMutation, AddAdminsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddAdminsMutation, AddAdminsMutationVariables>(AddAdminsDocument, options);
      }
export type AddAdminsMutationHookResult = ReturnType<typeof useAddAdminsMutation>;
export const ApproveGroupMembershipRequestsDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useApproveGroupMembershipRequestsMutation(baseOptions?: Apollo.MutationHookOptions<ApproveGroupMembershipRequestsMutation, ApproveGroupMembershipRequestsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ApproveGroupMembershipRequestsMutation, ApproveGroupMembershipRequestsMutationVariables>(ApproveGroupMembershipRequestsDocument, options);
      }
export type ApproveGroupMembershipRequestsMutationHookResult = ReturnType<typeof useApproveGroupMembershipRequestsMutation>;
export const BanGroupAccountsDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useBanGroupAccountsMutation(baseOptions?: Apollo.MutationHookOptions<BanGroupAccountsMutation, BanGroupAccountsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<BanGroupAccountsMutation, BanGroupAccountsMutationVariables>(BanGroupAccountsDocument, options);
      }
export type BanGroupAccountsMutationHookResult = ReturnType<typeof useBanGroupAccountsMutation>;
export const CancelGroupMembershipRequestDocument = gql`
...
export const RejectGroupMembershipRequestsDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useRejectGroupMembershipRequestsMutation(baseOptions?: Apollo.MutationHookOptions<RejectGroupMembershipRequestsMutation, RejectGroupMembershipRequestsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RejectGroupMembershipRequestsMutation, RejectGroupMembershipRequestsMutationVariables>(RejectGroupMembershipRequestsDocument, options);
      }
export type RejectGroupMembershipRequestsMutationHookResult = ReturnType<typeof useRejectGroupMembershipRequestsMutation>;
export const RemoveAdminsDocument = gql`
...
${SponsoredTransactionRequestFragmentDoc}
${TransactionWillFailFragmentDoc}`;
export function useRemoveAdminsMutation(baseOptions?: Apollo.MutationHookOptions<RemoveAdminsMutation, RemoveAdminsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveAdminsMutation, RemoveAdminsMutationVariables>(RemoveAdminsDocument, options);
      }
export type RemoveAdminsMutationHookResult = ReturnType<typeof useRemoveAdminsMutation>;
export const RequestGroupMembershipDocument = gql`
...
export const SetGroupMetadataDocument = gql`
...
export const UnbanGroupAccountsDocument = gql`
...
export const UpdateGroupRulesDocument = gql`
...
export const MlDismissRecommendedAccountsDocument = gql`
...
export const AddPostNotInterestedDocument = gql`
...
export const ExecutePostActionDocument = gql`
...
export const HideReplyDocument = gql`
...
export const UndoBookmarkPostDocument = gql`
...
export const UndoPostNotInterestedDocument = gql`
...
export const UndoReactionDocument = gql`
...
export const UnhideReplyDocument = gql`
...
export const AccountsAvailableDocument = gql`
...
export const AccountsBlockedDocument = gql`
...
export const AccountsBulkDocument = gql`
...
export const BalancesBulkDocument = gql`
...
export const FollowersYouKnowDocument = gql`
...
export const FullAccountDocument = gql`
...
export const NotificationIndicatorDocument = gql`
...
export const TokenDistributionsDocument = gql`
...
export const TopAccountsDocument = gql`
  ...
  posts(request: $request) {
    ...
    ${AccountFragmentDoc}`;
export function useTopAccountsQuery(baseOptions: Apollo.QueryHookOptions<TopAccountsQuery, TopAccountsQueryVariables> & ({ variables: TopAccountsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
// @ts-ignore
export function useTopAccountsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<TopAccountsQuery, TopAccountsQueryVariables>): Apollo.UseSuspenseQueryResult<TopAccountsQuery, TopAccountsQueryVariables>;
export function useTopAccountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TopAccountsQuery, TopAccountsQueryVariables>): Apollo.UseSuspenseQueryResult<TopAccountsQuery | undefined, TopAccountsQueryVariables>;
export function useTopAccountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TopAccountsQuery, TopAccountsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TopAccountsQuery, TopAccountsQueryVariables>(TopAccountsDocument, options);
        }
...
export type TopAccountsSuspenseQueryHookResult = ReturnType<typeof useTopAccountsSuspenseQuery>;
...
export const AuthenticatedSessionsDocument = gql`
...
export const AdminsForDocument = gql`
  ...
  adminsFor(request: $request) {
    ...
    ${AccountFragmentDoc}
${PaginatedResultInfoFragmentDoc}`;
export function useAdminsForQuery(baseOptions: Apollo.QueryHookOptions<AdminsForQuery, AdminsForQueryVariables> & ({ variables: AdminsForQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<AdminsForQuery, AdminsForQueryVariables>(AdminsForDocument, options);
      }
export function useAdminsForLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AdminsForQuery, AdminsForQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<AdminsForQuery, AdminsForQueryVariables>(AdminsForDocument, options);
        }
// @ts-ignore
export function useAdminsForSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<AdminsForQuery, AdminsForQueryVariables>): Apollo.UseSuspenseQueryResult<AdminsForQuery, AdminsForQueryVariables>;
export function useAdminsForSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<AdminsForQuery, AdminsForQueryVariables>): Apollo.UseSuspenseQueryResult<AdminsForQuery | undefined, AdminsForQueryVariables>;
export function useAdminsForSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<AdminsForQuery, AdminsForQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<AdminsForQuery, AdminsForQueryVariables>(AdminsForDocument, options);
        }
export type AdminsForQueryHookResult = ReturnType<typeof useAdminsForQuery>;
export type AdminsForLazyQueryHookResult = ReturnType<typeof useAdminsForLazyQuery>;
export type AdminsForSuspenseQueryHookResult = ReturnType<typeof useAdminsForSuspenseQuery>;
export const FullGroupDocument = gql`
  ...
  groupStats(request: $groupStatsRequest) {
    ...
    ${GroupFragmentDoc}`;
export function useFullGroupQuery(baseOptions: Apollo.QueryHookOptions<FullGroupQuery, FullGroupQueryVariables> & ({ variables: FullGroupQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<FullGroupQuery, FullGroupQueryVariables>(FullGroupDocument, options);
      }
export function useFullGroupLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<FullGroupQuery, FullGroupQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<FullGroupQuery, FullGroupQueryVariables>(FullGroupDocument, options);
        }
// @ts-ignore
export function useFullGroupSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FullGroupQuery, FullGroupQueryVariables>): Apollo.UseSuspenseQueryResult<FullGroupQuery, FullGroupQueryVariables>;
export function useFullGroupSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FullGroupQuery, FullGroupQueryVariables>): Apollo.UseSuspenseQueryResult<FullGroupQuery | undefined, FullGroupQueryVariables>;
export function useFullGroupSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FullGroupQuery, FullGroupQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FullGroupQuery, FullGroupQueryVariables>(FullGroupDocument, options);
        }
export type FullGroupQueryHookResult = ReturnType<typeof useFullGroupQuery>;
export type FullGroupLazyQueryHookResult = ReturnType<typeof useFullGroupLazyQuery>;
export type FullGroupSuspenseQueryHookResult = ReturnType<typeof useFullGroupSuspenseQuery>;
...
export const GroupBannedAccountsDocument = gql`
  ...
  groupBannedAccounts(request: $request) {
    ...
    ${AccountFragmentDoc}`;
export function useGroupBannedAccountsQuery(baseOptions: Apollo.QueryHookOptions<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables> & ({ variables: GroupBannedAccountsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>(GroupBannedAccountsDocument, options);
      }
export function useGroupBannedAccountsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>(GroupBannedAccountsDocument, options);
        }
// @ts-ignore
export function useGroupBannedAccountsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>): Apollo.UseSuspenseQueryResult<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>;
export function useGroupBannedAccountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>): Apollo.UseSuspenseQueryResult<GroupBannedAccountsQuery | undefined, GroupBannedAccountsQueryVariables>;
export function useGroupBannedAccountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GroupBannedAccountsQuery, GroupBannedAccountsQueryVariables>(GroupBannedAccountsDocument, options);
        }
export type GroupBannedAccountsQueryHookResult = ReturnType<typeof useGroupBannedAccountsQuery>;
export type GroupBannedAccountsLazyQueryHookResult = ReturnType<typeof useGroupBannedAccountsLazyQuery>;
export type GroupBannedAccountsSuspenseQueryHookResult = ReturnType<typeof useGroupBannedAccountsSuspenseQuery>;
...
export const GroupMembershipRequestsDocument = gql`
  ...
  groupMembershipRequests(request: $request) {
    ...
    ${AccountFragmentDoc}
${PaginatedResultInfoFragmentDoc}`;
export function useGroupMembershipRequestsQuery(baseOptions: Apollo.QueryHookOptions<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables> & ({ variables: GroupMembershipRequestsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>(GroupMembershipRequestsDocument, options);
      }
export function useGroupMembershipRequestsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>(GroupMembershipRequestsDocument, options);
        }
// @ts-ignore
export function useGroupMembershipRequestsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>): Apollo.UseSuspenseQueryResult<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>;
export function useGroupMembershipRequestsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>): Apollo.UseSuspenseQueryResult<GroupMembershipRequestsQuery | undefined, GroupMembershipRequestsQueryVariables>;
export function useGroupMembershipRequestsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GroupMembershipRequestsQuery, GroupMembershipRequestsQueryVariables>(GroupMembershipRequestsDocument, options);
        }
export type GroupMembershipRequestsQueryHookResult = ReturnType<typeof useGroupMembershipRequestsQuery>;
export type GroupMembershipRequestsLazyQueryHookResult = ReturnType<typeof useGroupMembershipRequestsLazyQuery>;
export type GroupMembershipRequestsSuspenseQueryHookResult = ReturnType<typeof useGroupMembershipRequestsSuspenseQuery>;
...
export const ProStatsDocument = gql`
...
export const AccountRecommendationsDocument = gql`
...
export const PostsExploreDocument = gql`
...
export const PostsForYouDocument = gql`
...
export const CollectActionDocument = gql`
...
export const HiddenCommentsDocument = gql`
...
export const WhoExecutedActionOnPostDocument = gql`
...
export const WhoReferencedPostDocument = gql`
